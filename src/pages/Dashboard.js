    ...
    <div className='flex flex-col items-center h-screen'>
      ...
      <div className='flex flex-col sm:flex-row h-full'>
        <div className='sm:w-1/3 border-r'>
          {/**Tabs */}
          <ul id="tabs" className="flex flex-wrap border-b-2 space-x-0 text-gray-800">
            <li className="inline-block py-2 px-4  hover:bg-gray-100 font-medium"><a id="default-tab" href="first">Enunciado</a></li>
            <li className="inline-block py-2 px-4 hover:bg-gray-100 font-medium"><a href="second">Menú</a></li>
            <li className="inline-block py-2 px-4 hover:bg-gray-100 font-medium"><a href="third">Notas</a> </li>
            <li className="inline-block py-2 px-4 hover:bg-gray-100 font-medium"><a href="fourth">Comentarios</a></li>
          </ul>
        ...
        <div className='flex flex-col sm:w-2/3 max-h-full'>
          ...
          <div className='flex h-full'>
            ...
            <div className='border-l border-t w-full p-3'>
              <p className='text-sm'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Gravida neque convallis a cras semper. Diam donec adipiscing tristique risus nec feugiat. Lectus quam id leo in vitae turpis massa.</p>
            </div>
          </div>
        </div>  
      </div> 
